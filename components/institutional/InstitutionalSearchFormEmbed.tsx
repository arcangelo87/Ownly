...
import { InstitutionalStep1 } from './steps/InstitutionalStep1';
import { InstitutionalStep2 } from './steps/InstitutionalStep2';
import { InstitutionalStep3 } from './steps/InstitutionalStep3';
import type { Step1Data } from './steps/InstitutionalStep1';
import type { Step2Data } from './steps/InstitutionalStep2';
...
export function InstitutionalSearchFormEmbed() {
  const t = useTranslations('institutionalSearch');
  ...
  return (
    <div>
      ...
      {currentStep === 1 && <InstitutionalStep1 onComplete={handleStep1Complete} />}
      {currentStep === 2 && <InstitutionalStep2 onComplete={handleStep2Complete} />}
      {currentStep === 3 && step1Data && step2Data && (
        <InstitutionalStep3 step1={step1Data} step2={step2Data} onComplete={handleStep3Complete} />
      )}
    </div>
  );
}
