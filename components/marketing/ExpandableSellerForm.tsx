...
import { SellerSearchFormEmbed } from '@/components/seller/SellerSearchFormEmbed';

interface ExpandableSellerFormProps {
  ctaLabel: string;
  note?: string;
}

export function ExpandableSellerForm({ ctaLabel, note }: ExpandableSellerFormProps) {
