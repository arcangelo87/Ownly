  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="self-start px-6 py-3 bg-[var(--color-accent)] text-white text-[14px] font-medium rounded-[4px] hover:opacity-90 transition-opacity disabled:opacity-60"
      >
