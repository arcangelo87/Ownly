...
import type { Step1Data } from './steps/SellerStep1';
import type { Step2Data } from './steps/SellerStep2';
...
export function SellerSearchFormEmbed() {
  const t = useTranslations('sellerSearch');
  ...
  return (
    <div>
      ...
      {currentStep === 1 && <SellerStep1 onComplete={handleStep1Complete} />}
      {currentStep === 2 && <SellerStep2 onComplete={handleStep2Complete} />}
      {currentStep === 3 && step1Data && step2Data && (
        <SellerStep3 step1={step1Data} step2={step2Data} onComplete={handleStep3Complete} />
      )}
    </div>
  );
}
