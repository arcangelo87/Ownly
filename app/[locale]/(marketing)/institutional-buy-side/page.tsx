...
export default function InstitutionalBuySidePage() {
  ...
  const problems = [
    { icon: Building2, label: t('problem.item1Label'), desc: t('problem.item1Desc') },
    { icon: Inbox, label: t('problem.item2Label'), desc: t('problem.item2Desc') },
    { icon: RefreshCw, label: t('problem.item3Label'), desc: t('problem.item3Desc') },
    { icon: GraduationCap, label: t('problem.item4Label'), desc: t('problem.item4Desc') },
    { icon: EyeOff, label: t('problem.item5Label'), desc: t('problem.item5Desc') },
  ];
  ...
  const steps = [
    ...
    { icon: ShieldCheck, label: t('howItWorks.step3Label'), desc: t('howItWorks.step3Desc') },
  ];
